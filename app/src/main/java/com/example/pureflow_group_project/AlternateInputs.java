...
public class AlternateInputs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_alternate_inputs);
            ...
            if (result != null) {
                try {
                    ...
                    if (results.length() > 0) {
                        ...
                        Toast.makeText(AlternateInputs.this, "Unable to find location", Toast.LENGTH_SHORT).show();
                    }
